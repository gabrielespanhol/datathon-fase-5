...
def test_run_baseline_returns_metrics_dict(monkeypatch, sample_data: pd.DataFrame) -> None:
    ...
    monkeypatch.setattr("src.models.baseline.mlflow.log_param", lambda *args, **kwargs: None)
    monkeypatch.setattr("src.models.baseline.mlflow.log_metrics", lambda *args, **kwargs: None)
    monkeypatch.setattr("src.models.baseline.mlflow.sklearn.log_model", lambda *args, **kwargs: None)
    ...
    monkeypatch.setattr("src.models.baseline.mlflow.start_run", lambda **kwargs: DummyRun())
...
def test_run_baseline_metrics_are_between_zero_and_one(monkeypatch, sample_data: pd.DataFrame) -> None:
